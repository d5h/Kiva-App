...
@property (strong, nonatomic) NSMutableArray *userCountries;
...
- (void)viewDidLoad {
    ...
    self.userCountries = [NSMutableArray array];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.valueLabel.font = [UIFont fontWithName:@"Helvetica-Neue" size:9.0];
